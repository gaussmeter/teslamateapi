...
func TeslaMateAPIVehiclesV1(c *gin.Context) {
	...
	*/
	...
	client := &http.Client{}
	req, _ := http.NewRequest(http.MethodGet, "https://owner-api.teslamotors.com/api/1/vehicles/", strings.NewReader(string(reqBody)))
