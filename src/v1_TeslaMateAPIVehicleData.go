...
func TeslaMateAPICarsVehicleDataV1(c *gin.Context) {
	...
	*/
	...
	client := &http.Client{}
	req, _ := http.NewRequest(http.MethodGet, "https://owner-api.teslamotors.com/api/1/vehicles/"+TeslaVehicleID+"/vehicle_data", strings.NewReader(string(reqBody)))
